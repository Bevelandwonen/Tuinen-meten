...
if __name__ == "__main__": 
    ...
    #TODO: remove this. We dont use data.df_units in other functions
    #df_units_new = data.df_units
    df_units_filtered = data.df_units.dropna(subset=["Perceelnummer"])
    all_results = []
    ...
    for plotnumber in df_units_filtered["Perceelnummer"].unique():
        ...
        if parcel_type == "single":
            single_house(data, plot_poly, gdf_bag_in_plot, gdf_road_in_plot)
